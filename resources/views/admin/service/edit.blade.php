    ...
    <div class="container-fluid card  p-4">
        ...
        <form action="{{ route("admin.service.update",["id"=>$service[0]["id"]]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-lg-12 row">
                ...
                <div class="col-lg-10 form-group">
                    <input type="text" class="form-control" id="serviceDescription" name="serviceDescription" value="{{ $service[0]["text"] }}" placeholder="Hizmet Açıklama Girin!" aria-describedby="">
                </div>
            </div>
