...
(function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return {
            define: function (b, d) {
                ...
                function p(a, f, B, h) {
                    a = {name: b, sender: this, editor: a, data: f, listenerData: k, stop: B, cancel: h, removeListener: r};
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, h = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, p = function (a, f) {
    ...
    (function () {
        ...
        function z(a, b, l, e) {
            ...
            if (e.doFilter) {
                a:{
                    ...
                    v = e.skipRequired;
                    var A = {valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1}, k, C;
                    if (a || f) {
                        u(b);
        ...
        function l(a, b, c) {
            var d = a.name;
            if (D.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({check: "it", el: a.parent}), a.remove()); else if (D.$block[d] || "tr" == d) if ("br" == b) a.previous && !F(a.previous) && (b = w(), b.insertBefore(a)), a.next && !F(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, l;
                b:{
                    l = D[b];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, q = [], n = this.editor && this.editor.config.protectedSource, t, f = !1, g = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
    ...
    (function () {
        ...
        var x = /(?:&nbsp;|\xa0)$/, J = "{cke_protected}", w = CKEDITOR.dtd, F = "caption colgroup col thead tfoot tbody".split(" "), l = CKEDITOR.tools.extend({}, w.$blockLimit,
            w.$block), q = {elements: {input: h, textarea: h}}, n = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, t = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
    ...
    (function () {
        ...
        m = function () {
            ...
            function b(c, d) {
                ...
                "br" != n || !e.data("cke-eol") || h && h != A - 1 || (r = (f = h ? g[h - 1].node : C.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && p.$block[f.getName()]), -1 != D || t || (D = h), t || (m = h), g.push({isElement: 1, isLineBreak: r, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: n, allowed: t}), f = r = 0)) : g.push({isElement: 0, node: e, allowed: 1});
            ...
            var p = CKEDITOR.dtd, m = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, r = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, x = CKEDITOR.tools.extend({},
                p.$inline);
            delete x.br;
            ...
            getNative: function () {
                ...
                var a = B ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, l, g = b.duplicate(), h = 0, k = e.length - 1, v = -1, n, m; h <= k;) if (v = Math.floor((h + k) / 2), f = e[v], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n) k = v - 1; else if (0 > n) h = v + 1; else return {container: d, offset: a(f)};
...
*/
        ...
        CKEDITOR.plugins.add("dialogadvtab", {
            requires: "dialog", allowedContent: function (c) {
                ...
                if (a.styles || a.classes) e = [], a.styles && e.push({
                    id: "advStyles", att: "style", type: "text", requiredContent: b ? b + "{cke-xyz}" : null, label: d.styles, "default": "", validate: CKEDITOR.dialog.validate.inlineStyle(d.invalidInlineStyle), onChange: function () {
    ...
    (function () {
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            isFileApiSupported: !CKEDITOR.env.ie || 9 < CKEDITOR.env.version, mainPasteEvent: CKEDITOR.env.ie && !CKEDITOR.env.edge ? "beforepaste" : "paste", canClipboardApiBeTrusted: function (b, a) {
            ...
            $: function (a, b, c, l) {
                ...
                addBlock: function (a, b) {
                    ...
                    var k = this.element, e = this._.iframe, e = CKEDITOR.env.ie && !CKEDITOR.env.edge ? e : new CKEDITOR.dom.window(e.$.contentWindow), f = k.getDocument(), r = this._.parentElement.getPositionedAncestor(),
                        t = b.getDocumentPosition(f), f = r ? r.getDocumentPosition(f) : {x: 0, y: 0}, q = "rtl" == this._.dir, d = t.x + (l || 0) - f.x, n = t.y + (h || 0) - f.y;
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (e) {
            function t(a, c, f, g, l) {
                var m = new CKEDITOR.style(k["colorButton_" + c + "Style"]), n = CKEDITOR.tools.getNextId() + "_colorBox";
                l = l || {};
                e.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    label: f, title: f, modes: {wysiwyg: 1}, editorFocus: 0, toolbar: "colors," + g, allowedContent: m, requiredContent: m, contentTransformations: l.contentTransformations, panel: {css: CKEDITOR.skin.getPath("editor"), attributes: {role: "listbox", "aria-label": h.panelTitle}}, onBlock: function (a,
                        ...
                        e.activeFilter.check(m) || this.setState(CKEDITOR.TRISTATE_DISABLED)
                    }, onOpen: function () {
                        var a = e.getSelection(), a = a && a.getStartElement(), a = e.elementPath(a), b;
                        if (a) {
                            a =
            ...
            function x(a, c, f) {
                var g = [], l = k.colorButton_colors.split(","), m = k.colorButton_colorsPerRow || 6, n = e.plugins.colordialog && !1 !== k.colorButton_enableMore, p = l.length +
                    ...
                    function d(a) {
                        ...
                        "ok" == a.name && f(this.getContentElement("picker", "selectedColor").getValue(), c)
                    }

                    var f = arguments.callee;
                    if ("?" == b) e.openDialog("colordialog", function () {
                        this.on("ok", d);
                        this.on("cancel", d)
                    }); else {
                        e.focus();
            ...
            var k = e.config, h = e.lang.colorbutton;
            if (!CKEDITOR.env.hc) {
                ...
                var v = {}, w = e.config.colorButton_normalizeBackground;
    ...
    (function () {
        ...
        var l = CKEDITOR.tools.indexOf, t = !1;
            ...
            lang: "en", icons: "copyformatting", hidpi: !0, init: function (a) {
                ...
                a.on("contentDom", function () {
                    ...
                    e.attachListener(b, "mouseup", function (b) {
                        r(b) && a.execCommand("applyFormatting")
                    });
        ...
        CKEDITOR.plugins.copyformatting = {
            ...
            preservedElements: "ul ol li td th tr thead tbody table".split(" "), breakOnElements: ["ul", "ol", "table"], commands: {
                copyFormatting: {
                    exec: function (a, b) {
                        var e = CKEDITOR.plugins.copyformatting, d = a.copyFormatting, c = b ? "keystrokeHandler" == b.from : !1, f = b ? b.sticky || c : !1, g = e._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
                    ...
                    exec: function (a, b) {
                        var e = a.getCommand("copyFormatting"), d = b ? "keystrokeHandler" ==
                            b.from : !1, c = CKEDITOR.plugins.copyformatting, f = a.copyFormatting, g = c._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
                ...
                function d(a, c) {
                    ...
                    if (m) c ? n = 0 : (g = /([\.\b]*$)/, n = (k = g.exec(h)) ? k.index : h.length); else if (c && (n +=
                ...
                for (f = e(h); null != (g = c.exec(f));) if (g.index + g[0].length >= a.startOffset) return a = g.index, c = g.index + g[0].length, 0 === g.index && (g = d(h, !0), m = g.node, a = g.offset), c >= f.length && (f = d(h), k = f.node, c = f.offset), {startNode: m, startOffset: a, endNode: k, endOffset: c};
                return null
                ...
                for (g = 0; g < e.length; g++) c = e[g], f = b.createBookmark(), -1 !== l(["table",
                    "tr"], c.element) ? k(b, c.element, function (a) {
                    c.applyToObject(a)
    ...
    (function () {
        function n(a, c, h, e, q, n, u, w) {
            var x = a.config, r = new CKEDITOR.style(u), g = q.split(";");
            q = [];
            for (var m = {}, d = 0; d < g.length; d++) {
                var l = g[d];
                if (l) {
                    var l = l.split("/"), v = {}, p = g[d] = l[0];
                    v[h] = q[d] = l[1] || p;
            ...
            a.ui.addRichCombo(c, {
                ...
                init: function () {
                    ...
                    a.focus();
                    a.fire("saveSnapshot");
                    var c = this.getValue(), h = m[b];
                    if (c && b != c) {
                        var e = m[c], f = a.getSelection().getRanges()[0];
                        if (f.collapsed) {
                            var g = a.elementPath(), k = g.contains(function (a) {
                                return e.checkElementRemovable(a)
                            });
                            if (k) {
                                var d = f.checkBoundaryOfElement(k, CKEDITOR.START), l = f.checkBoundaryOfElement(k, CKEDITOR.END);
                                if (d && l) {
                    ...
                    a.on("selectionChange", function (b) {
                        ...
                        for (var d = 0, e; d < b.length; d++) {
                            e = b[d];
                            for (var f in m) if (m[f].checkElementMatch(e,
                                !0, a)) {
                                f != c && this.setValue(f);
                                return
                            }
        ...
        CKEDITOR.plugins.add("language", {
            requires: "menubutton", init: function (a) {
                ...
                for (f = 0; f < b.length; f++) g = b[f].split(":"), h = g[0], k = "language_" + h, e[k] = {
                    label: g[1], langId: h, group: "language", order: f, ltr: "rtl" != ("" + g[2]).toLowerCase(), onClick: function () {
            ...
            parseLinkAttributes: function (c, b) {
                ...
                if (b) {
                    if (a = b.getAttribute("target")) g.target = {
                        type: a.match(z) ?
                            a : "frame", name: a
                    }; else if (a = (a = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && a.match(C)) for (g.target = {type: "popup", name: a[1]}; e = D.exec(a[2]);) "yes" != e[2] && "1" != e[2] || e[1] in {height: 1, width: 1, top: 1, left: 1} ? isFinite(e[2]) && (g.target[e[1]] = e[2]) : g.target[e[1]] = !0;
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function (c) {
                ...
                if (b && (f = b.getSelectedElement()) &&
                    (f.getChildCount() ? f.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f))) f.remove(1); else if (f = CKEDITOR.plugins.link.getSelectedLink(c)) f.hasAttribute("href") ? (f.removeAttributes({name: 1, "data-cke-saved-name": 1}), f.removeClass("cke_anchor")) : f.remove(1);
                b.selectBookmarks(a)
    ...
    (function () {
        CKEDITOR.plugins.liststyle = {
            requires: "dialog,contextmenu", init: function (a) {
                if (!a.blockless) {
                    var b;
                    b = new CKEDITOR.dialogCommand("numberedListStyle", {requiredContent: "ol", allowedContent: "ol{list-style-type}[start]; li{list-style-type}[value]", contentTransformations: [["ol: listTypeToStyle"]]});
                ...
                a.addCommand("pastefromword", {
                    canUndo: !1, async: !0, exec: function (a) {
                        ...
                        a.getClipboardData({title: a.lang.pastefromword.title}, function (b) {
                            b && a.fire("paste",
                                {type: "html", dataValue: b.dataValue, method: "paste", dataTransfer: CKEDITOR.plugins.clipboard.initPasteDataTransfer()});
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("preview", {
            init: function (a) {
                a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && (h = this.path, a.addCommand("preview", k), a.ui.addButton && a.ui.addButton("Preview", {label: a.lang.preview.preview, command: "preview", toolbar: "document,40"}))
            }
        })
    })();
